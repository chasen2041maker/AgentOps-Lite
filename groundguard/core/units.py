...
def unit_multiplier_and_name(unit: str | None) -> tuple[Decimal, str | None]:
    ...
    scaled_units = {
        ...
        "billion_cny": (Decimal("1000000000"), "CNY"),
        "cny_billion": (Decimal("1000000000"), "CNY"),
        "cny_bn": (Decimal("1000000000"), "CNY"),
        "cny_m": (Decimal("1000000"), "CNY"),
        "million_cny": (Decimal("1000000"), "CNY"),
        "cny_million": (Decimal("1000000"), "CNY"),
        "cny_mn": (Decimal("1000000"), "CNY"),
        "cny_k": (Decimal("1000"), "CNY"),
        "thousand_cny": (Decimal("1000"), "CNY"),
        "cny_thousand": (Decimal("1000"), "CNY"),
        ...
        "billion_usd": (Decimal("1000000000"), "USD"),
        "usd_billion": (Decimal("1000000000"), "USD"),
        "usd_bn": (Decimal("1000000000"), "USD"),
        "usd_m": (Decimal("1000000"), "USD"),
        "million_usd": (Decimal("1000000"), "USD"),
        "usd_million": (Decimal("1000000"), "USD"),
        "usd_mn": (Decimal("1000000"), "USD"),
        "usd_k": (Decimal("1000"), "USD"),
        "thousand_usd": (Decimal("1000"), "USD"),
        "usd_thousand": (Decimal("1000"), "USD"),
