...
- 规则版数字声明抽取，支持 `[fact:key]` 显式引用、中文金额、百分比和常见英文 USD 金额。
...
当前声明抽取范围是刻意收窄的：只抽取带单位或量级词的数值声明，例如 `823.2 亿元`、`21.5%`、`10.25 亿美元`、`$3.83 billion`、`USD 10.25M`、`2.5 million dollars`。没有单位的裸数字会被忽略，以减少误报。
