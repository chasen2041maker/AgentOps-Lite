...
def test_release_metadata_is_consistent_for_local_release_candidate():
    ...
    assert f"`{version}`; it has not been uploaded to PyPI" in readme
    assert "Latest PyPI release: `0.3.1`" in readme
